...
const FIELDS: { key: string; label: string; type: "text" | "textarea" | "image" }[] = [
  ...
  { key: "about_text", label: "درباره رودا - پاراگراف اول", type: "textarea" },
  { key: "about_text_2", label: "درباره رودا - پاراگراف دوم", type: "textarea" },
  { key: "about_founder_title", label: "درباره رودا - عنوان بخش سازنده", type: "text" },
  { key: "about_founder_text", label: "درباره رودا - متن معرفی سازنده", type: "textarea" },
  { key: "telegram_username", label: "آیدی تلگرام", type: "text" },
  { key: "telegram_url", label: "لینک تلگرام", type: "text" },
  { key: "instagram_username", label: "آیدی اینستاگرام", type: "text" },
  { key: "instagram_url", label: "لینک اینستاگرام", type: "text" },
  { key: "rubika_username", label: "آیدی روبیکا", type: "text" },
  { key: "rubika_url", label: "لینک روبیکا", type: "text" },
  { key: "rubika_channel_url", label: "لینک کانال روبیکا", type: "text" },
